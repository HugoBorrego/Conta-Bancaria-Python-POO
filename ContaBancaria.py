...
class Cliente:
    def __int__(self, endereco):
        ...
        self.contas = []  # Não inicia contas no construtor pois pode começar sem contas
...
class PessoaFisica(Cliente): # Herda de Cliente
    def __init__(self, nome, data_nascimento, cpf, endereco):
        super().__init__(endereco) # Chamando construtor da classe Cliente
        self.nome = nome
...
class Conta:
    ...
    @classmethod  # Recebe uma instancia de Conta
...
class ContaCorrente(Conta): # Herda de Conta
    ...
    def sacar(self, valor):
        ...
        excedeu_limite = valor > valor > self._limite
